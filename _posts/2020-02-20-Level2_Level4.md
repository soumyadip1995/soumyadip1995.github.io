...
We will try to gain perspective on what constitutes as level 2 and level 4. With the rise in Autopilot Systems by Tesla and Maps, Lidar  by Waymo, it is definitely worth the time to look into these levels and try to generate a case study on the basis of open questions and the stats.
